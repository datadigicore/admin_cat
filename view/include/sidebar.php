  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <?php if ($_SESSION['level'] == 1): ?>
        ...
        <li><a href="<?php echo $url_rewrite;?>content/file-ruangan"><i class="fa fa-user"></i> <span>Manage PDF</span></a></li>
        <li><a href="<?php echo $url_rewrite;?>content/monitor-file"><i class="fa fa-file-text-o"></i> <span>Monitoring File</span></a></li>
        <li><a href="<?php echo $url_rewrite;?>content/log"><i class="fa fa-file-text-o"></i> <span>Monitoring Revisi</span></a></li>
