  ...
  <div class="wrapper">
    <header class="main-header">
      <a href="index2.html" class="logo">
        <span class="logo-mini"><img src="<?php echo $url_rewrite;?>static/dist/img/iconpolda.png" style="padding:6px"></span>
        <span class="logo-lg"><img src="<?php echo $url_rewrite;?>static/dist/img/iconpolda.png" style="padding:4px"> <b>CAT</b> POLDA</span>
      </a>
          ...
          <ul class="nav navbar-nav">
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo $url_rewrite;?>static/dist/img/iconpolda.png" class="user-image" alt="User Image">
                <span class="hidden-xs">Admin CAT Polda</span>
              </a>
              <ul class="dropdown-menu" style="border-right:none;">
                <li class="user-header">
                  <img src="<?php echo $url_rewrite;?>static/dist/img/iconpolda.png" class="img-circle" alt="User Image">
                  <p>
                    Admin - CAT Polda
                    <small>Administrator & Monitoring CAT Polda</small>
                  </p>
                </li>
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="#editProfil" data-toggle="modal" class="btn btn-default btn-flat">Profile</a>
                  </div>
