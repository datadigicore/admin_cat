      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
              ...
              <!-- <div class="col-xs-4"> -->
                <!-- <button class="btn btn-danger btn-xs" id="btn-prev" >Kembali</button> -->
                <!-- <button class="btn btn-success btn-xs" id="btn-next" >Selanjutnya</button>
                <button class="btn btn-primary btn-xs" id="btn-" >Refresh</button> -->
              <!-- </div> -->
              
                <label class="col-xs-1" >Nomor / Nama Peserta</label>
              
              <div class="col-xs-3">
                <select class="form-control" id="select_peserta">
                <?php $peserta = $ujian->get_data_peserta($_SESSION['ruangan']); ?>
                    <?php foreach ($peserta as $key => $value) { ?>            
                      <option value="<?php echo $value['id_peserta']; ?>" > <?php echo $value['no_peserta']." - ".$value['nama'];?></option>
                      <?php $no++; } ?>
                    </select>
              </div>
                <label class="col-xs-1" \>Alasan Mengulang</label>
          ...
          <div class="box-body">            
                <button class="btn btn-block btn-success" id="btn-submit" >Tambah Data Pengulangan</button>
                <!-- <button class="btn btn-danger" id="btn-cancel" >Reset Form</button> -->
          </div>
          <div class="box-body">
