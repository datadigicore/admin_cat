...
class SSP {
        ...
        for ( $i=0, $ien=count($data) ; $i<$ien ; $i++ ) {
            ...
            for ( $j=0, $jen=count($columns) ; $j<$jen ; $j++ ) {
                ...
                if ( isset( $column['formatter'] ) ) {
                    $row[ $column['dt'] ] = $column['formatter']( $data[$i][ $column['db'] ], $data[$i], $new );
                }
                else {
    ...
    static function simplejoin3 ( $request, $conn, $table, $primaryKey, $columns, $tableJoin=null, $joinWhere=null, $whereResult=null)
    {
        $bindings = array();
        $db = self::db( $conn );
    ...
    static function simplemorejoin ( $request, $conn, $table, $primaryKey, $columns, $join=null, $whereResult=null)
    {
        $bindings = array();
        $db = self::db( $conn );
        $localWhereResult = array();
